...
import com.example.homework2.databinding.FragmentFriendBinding
...
class FriendFragment : Fragment(R.layout.fragment_friend) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val text = "From FriendFragment"


        with(binding){
            buttonToEnd.setOnClickListener(){
                findNavController().navigate(R.id.action_friendFragment_to_endFragment)
